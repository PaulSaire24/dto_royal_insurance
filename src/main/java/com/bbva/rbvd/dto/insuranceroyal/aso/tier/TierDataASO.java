...
public class TierDataASO extends CommonFieldsASO {
    ...
    private List<com.bbva.rbvd.dto.insuranceroyal.aso.tier.TierSegmentASO> segments;
    ...
    public List<com.bbva.rbvd.dto.insuranceroyal.aso.tier.TierSegmentASO> getSegments() { return segments; }
    public void setSegments(List<com.bbva.rbvd.dto.insuranceroyal.aso.tier.TierSegmentASO> segments) { this.segments = segments; }
